...
<style lang="scss" scoped>
    ...
    /* banner 广告图 大小  */
    .swiper { margin-top: 48px; }  
    .swiper, .swiper-item, .slide-image { width: 100%; height: 320px;}
    .double_list {
        width: 100%;
    ...
    .sorts.weui-flex {  background-color: #fff;font-size: 16px;border-top: 1px solid #ddd;
